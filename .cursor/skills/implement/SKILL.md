---
name: implement
description: SOLID principles, interface segregation, dependency injection, requirement decomposition, and 10 essential design patterns (Strategy, Adapter, Factory, Observer, Decorator, Builder, Repository, Middleware, Facade, Command). Use when the user says implement, design, architect, build a feature, or asks about design patterns, SOLID, or dependency injection.
---
