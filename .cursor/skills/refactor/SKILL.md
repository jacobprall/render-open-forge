---
name: refactor
description: Code smell to refactoring cross-reference based on Fowler's Refactoring (2nd ed) catalog. Use when the user says refactor, clean up, code smell, technical debt, or asks how to improve existing code structure.
---
